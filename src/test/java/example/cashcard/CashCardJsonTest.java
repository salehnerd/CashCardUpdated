...
import org.springframework.boot.test.json.JacksonTester; //s a convenience wrapper to the Jackson JSON parsing library. It handles serialization and deserialization of JSON objects.
